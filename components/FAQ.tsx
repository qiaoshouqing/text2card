    ...
    <section className="w-full max-w-4xl mx-auto">
        ...
        <div className="space-y-10">
            ...
            <FAQItem
                ...
                answer="SlothCard's card maker is designed with simplicity in mind. Our random design approach takes the pressure off users to make complex design decisions. This makes it perfect for beginners who want professional-looking results without needing any design experience. Just input your text, and let our card maker do the creative heavy lifting!"
            />
            <FAQItem
